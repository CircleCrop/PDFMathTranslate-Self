...
def _get_default_service_name() -> str:
    default_service = DEFAULT_TRANSLATION_ENGINE_METADATA.translate_engine_type
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                siliconflow_free_acknowledgement = gr.Markdown(
                    ...
                    visible=_get_default_service_name() == "SiliconFlowFree",
                )
                ...
                with gr.Group() as translation_engine_settings:
                    service = gr.Dropdown(
                        ...
                        value=_get_default_service_name(),
                    )
        ...
        def load_saved_config_to_ui(state):
            ...
            try:
                ...
                if not selected_service:
                    selected_service = _get_default_service_name()
